...
| R-001 | P0 | PLAN-1; GLM P0-1,P2-28 | LLM SQL 使用应用主连接，正则黑名单可绕过 | 专用只读角色与连接；SQL AST allowlist；READ ONLY/超时/结果上限 | 多语句、写 CTE、系统表、危险函数、注释混淆、子查询和超时攻击均被拒绝；DB 角色无写权限 | 已修复 | |
